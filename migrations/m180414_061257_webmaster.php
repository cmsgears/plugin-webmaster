...
/**
 * The webmaster migration inserts the base data required for webmasters.
 *
 * @since 1.0.0
 */
class m180414_061257_webmaster extends Migration {
	...
	private function insertFileConfig() {
		...
		$this->insert( $this->prefix . 'core_form', [
			...
			'name' => 'Config Webmaster', 'slug' => 'config-webmaster',
			'type' => CoreGlobal::TYPE_SYSTEM,
			'description' => 'Webmaster configuration form.',
		...
		$config	= Form::findBySlugType( 'config-webmaster', CoreGlobal::TYPE_SYSTEM );
	...
	private function insertDefaultConfig() {
		...
		$metas	= [
			[ $this->site->id, 'active', 'Active', 'webmaster', 1, 'flag', '1', NULL ]
		];
	...
	public function down() {
		...
		echo "m180414_061257_webmaster will be deleted with m160621_014408_core.\n";
